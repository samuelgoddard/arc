...
export default function PinnedArc() {
  ...
  return(
    <m.div style={{ translateY: y }} className="bg-transparent left-0 right-0 w-full h-[80vh] lg:h-screen text-[80px]/none lg:text-[160px]/none text-white z-[100] fixed px-3 pointer-events-none flex items-center will-change-transform">
