          ...
          <main className="block">
            ...
            <m.div variants={fade} className="h-[calc(100vh-12px)] w-full mb-3 relative z-[100]">
              ...
              <div className="w-full h-full border-b border-black relative flex items-start lg:items-center justify-center pt-24 lg:pt-0">
                ...
                <div className="absolute bottom-0 py-3 left-0 hidden lg:block w-full bg-off-white z-10 px-3">
                  <span className=" w-[80%] max-w-[480px] text-base/tight hidden lg:block">{home.heroText}</span>
                </div>

                <div className="absolute bottom-0 py-3 left-0 lg:left-auto lg:right-0 z-10 bg-off-white w-full lg:w-auto px-3">
                  <span className="block lg:hidden w-[85%] max-w-[480px] text-base/tight mb-8 lg:mb-0">{home.heroText}</span>

                  <div className="flex space-x-4 items-center">
                    <div className="w-[90px] lg:w-[160px] relative z-[10] opacity-1 bg-off-white">
                    ...
                    <div className="w-[100px] lg:w-[140px] mb-[5px] relative z-[10] opacity-1 bg-off-white">
                      <Image
                        src="/images/arb.jpg"
                        width={250}
                        height={62}
                    ...
                    <div className="w-[70px] lg:w-[100px] relative z-[10] opacity-1 bg-off-white">
                      <Image
                        src="/images/riba.jpg"
                        width={174}
                        height={82}
